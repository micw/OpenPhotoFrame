...
abstract class AppLocalizations {
  ...
  /// No description provided for @darkScreenOnDelay.
  ///
  /// In en, this message translates to:
  /// **'Delay for screen on'**
  String get darkScreenOnDelay;

  /// No description provided for @darkScreenOffDelay.
  ///
  /// In en, this message translates to:
  /// **'Delay for screen off'**
  String get darkScreenOffDelay;
